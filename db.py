...
_IDENTIFIERS = sorted(
    [
        ...
        "SiteSettings", "DepartmentGoals",
        "AchievementId", "TeacherBadgeId", "ReviewId", "EventId", "LogId",
        "AdminId", "TeacherId", "TypeId", "BadgeId", "ReviewerId", "UserId", "GoalId",
        "UpdatedAt",
        ...
        "IsApproved", "IsRejected", "IsBlocked", "Department", "Position", "Username",
        "YearlyGoal", "LastLoginAt", "Bio", "Phone", "Role", "AcademicYear",
        "SettingKey", "SettingValue", "DeptScore", "TeacherCount", "YearScore",
        "YearAchCount", "LastActivity",
